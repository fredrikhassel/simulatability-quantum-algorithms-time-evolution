...
#plotTrotterPAI("TE-PAI-noSampling/NNN_data/trotterThenTEPAI/Δ-pi_over-1024-q-10-N1-100-T1-1.0-N2-100-p-100-T2-2.0-dt-0.1")
#quit()
...
if False:
    plot_trotter_then_tepai(
        base_dir = Path("TE-PAI-noSampling/NNN_data/trotterThenTEPAI"),
        Δ_name='pi_over-1024',
        q = 10,
        N1= 100,
        T1= 1,
